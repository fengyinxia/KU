...
(function() {
    ...
    obj.initPlayer = function (player) {
        ...
        obj.playerReady(player, function(player) {
            obj.gestureInit(player), obj.longPressInit(player), obj.dblclickInit(player), obj.dPlayerPip(player), obj.dPlayerSubtitleSetting()
    ...
    obj.dPlayerSetting = function (player) {
        ...
        user.init();
        user.set("autoposition", 0), user.set("autoplaynext", 0), user.set("soundenhancement", 0), user.set("imageenhancement", 0);
    ...
    obj.resetPlayer = function () {
        obj.async("file-widget-1:videoPlay/context.js", function(c) {
            var count, id = count = setInterval(function() {
                var playerInstance = c && c.getContext()?.playerInstance
